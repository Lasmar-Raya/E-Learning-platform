                        ...
                        <ul class=" navigation-box">
                            ...
                            <?php
                                ...
                                $row=$get_contact->fetch();
                                    ...
                                    {
                                    echo"  <img src='assets/avatar/". $row['id'] ."/". $row['avatar']."' style='border-radius:50%;height:20px; width:20px ;margin-right:10px;'/ >";
                            
                                    }
                                    else{
                            
                                    echo "<img src='assets/avatar/defaults/user.png' style='border-radius:50%;height:20px;margin-right:10px;'/>";
