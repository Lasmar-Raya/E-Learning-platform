...
<body>
    ...
    <div class="page-wrapper">
        ...
        <div id="wrap">
            <div id='user_l'  style="background-image: url(assets/images/s3.jpg) ; background-size:cover;">
                <center><img src='assets/images/semestre3.gif'/></center>
                <h1> Semestre 3</h1>
                <ul>
                <?php
            ...
            <div id='user_r' >
                <br>
                <a href="cursus.php" style="font-size:20px; background-color:#c3633d; border-radius:50%; color:white; padding: 5px 15px ;"> <i class="fa fa-chevron-left"></i></a>
                <br>
                 <center><div style="color:white; box-shadow: 8px 8px 30px #000; background-color:#c3633d; font-family:satisfy; width:50%; border-radius:15px;" ><h1> Semestre 3 </h1></div></center>
                 <?php 
